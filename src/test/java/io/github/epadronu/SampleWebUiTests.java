...
import static io.github.epadronu.dwalin.core.Dwalin.navigateTo;
 ...
 * </p>
 */
@DisplayName("Sample Web UI tests")
public final class SampleWebUiTests extends DwalinWebDriverTest {
  ...
  void shouldFirstResultBeOraclesAndHaveSiteLinksWhenSearchingForJava() {
    ...
    final SearchResult<DuckDuckGoSearchResultPage> firstResult = navigateTo(DuckDuckGoHomePage.class)
        .searchBox()
        .search("java")
        .results()
        .getFirst();
